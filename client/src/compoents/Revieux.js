...
function Revieux() {
  return (
    <div className="container">
            ...
            <button type="button" className="btn btn-primary" style={{backgroundColor: '#605DEC'}}>Explore More Stays</button>
            </div>
            <div className='title'> <h2>What Tripma users are saying</h2></div>
            <div className="row">
        ...
        <div className="col-md-4">
          <div className="card mb-3">
            <div className="card-body d-flex align-items-center">
              <img src="https://s3-alpha-sig.figma.com/img/743f/cc74/57d662f00d00d62189f259083dccb984?Expires=1712534400&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=KDT4M9XO9LVz7ZCU7kSHoJ5QySBAbDZQo5pV5f9ZsV~yr1KDwNtuXyjQOiF0aSXV4~4dbFulOHm2BjEIJcEYEbPa5d2dL79-fjuqfPj6hztnb-VB2sw~EfAniaK-~fZhJn~~0lCbpzxgYMErFomvbkXtxZxzxO7ah9dMj3hdWXaReaPMvDBnWUK-YK5nCpZw-dVb15d2PACyKlPgwR0i0qbXaYNU-hR~E6CClmGG4xbkQUN7rB~Bbhdo-OjTjjUi6p8sas0gLaXCmUYxirQ9E0sHYI9NKOjVUzoDfZGO65YxpKojhjpi44oeikNUX94bKyHOUerdtkDlhY4ZKlW47A__"style={{ width: '48px', height: '48px' }} className="rounded-circle mr-3" alt="Jane Smith" />
              <div>
                <h5 className="card-title mb-1">Jane Smith</h5>
                <p className="card-subtitle text-muted mb-0">March 26, 2024</p>
                <p>  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-star" viewBox="0 0 16 16">
  <path d="M2.866 14.85c-.078.444.36.791.746.593l4.39-2.256 4.389 2.256c.386.198.824-.149.746-.592l-.83-4.73 3.522-3.356c.33-.314.16-.888-.282-.95l-4.898-.696L8.465.792a.513.513 0 0 0-.927 0L5.354 5.12l-4.898.696c-.441.062-.612.636-.283.95l3.523 3.356-.83 4.73zm4.905-2.767-3.686 1.894.694-3.957a.56.56 0 0 0-.163-.505L1.71 6.745l4.052-.576a.53.53 0 0 0 .393-.288L8 2.223l1.847 3.658a.53.53 0 0 0 .393.288l4.052.575-2.906 2.77a.56.56 0 0 0-.163.506l.694 3.957-3.686-1.894a.5.5 0 0 0-.461 0z"/>
</svg><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-star" viewBox="0 0 16 16">
  <path d="M2.866 14.85c-.078.444.36.791.746.593l4.39-2.256 4.389 2.256c.386.198.824-.149.746-.592l-.83-4.73 3.522-3.356c.33-.314.16-.888-.282-.95l-4.898-.696L8.465.792a.513.513 0 0 0-.927 0L5.354 5.12l-4.898.696c-.441.062-.612.636-.283.95l3.523 3.356-.83 4.73zm4.905-2.767-3.686 1.894.694-3.957a.56.56 0 0 0-.163-.505L1.71 6.745l4.052-.576a.53.53 0 0 0 .393-.288L8 2.223l1.847 3.658a.53.53 0 0 0 .393.288l4.052.575-2.906 2.77a.56.56 0 0 0-.163.506l.694 3.957-3.686-1.894a.5.5 0 0 0-.461 0z"/>
  ...
  <path d="M2.866 14.85c-.078.444.36.791.746.593l4.39-2.256 4.389 2.256c.386.198.824-.149.746-.592l-.83-4.73 3.522-3.356c.33-.314.16-.888-.282-.95l-4.898-.696L8.465.792a.513.513 0 0 0-.927 0L5.354 5.12l-4.898.696c-.441.062-.612.636-.283.95l3.523 3.356-.83 4.73zm4.905-2.767-3.686 1.894.694-3.957a.56.56 0 0 0-.163-.505L1.71 6.745l4.052-.576a.53.53 0 0 0 .393-.288L8 2.223l1.847 3.658a.53.53 0 0 0 .393.288l4.052.575-2.906 2.77a.56.56 0 0 0-.163.506l.694 3.957-3.686-1.894a.5.5 0 0 0-.461 0z"/>
        ...
        <div className="col-md-4">
          <div className="card mb-3">
            <div className="card-body d-flex align-items-center">
              <img src="https://s3-alpha-sig.figma.com/img/982f/cff3/c51187040833102b8e000d3c3f537011?Expires=1712534400&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=JWkyHDmxzdS8pc4u7SxO5sUgweMc7TmzxKgydESAqSIh6JhibPQ-LQC6hS1wsmVkSeItwVy~IzvnoQ435Ho7PzB3RPHJiHPIwa-TD-DzIpf2Pd6ItlKbEaO6cDZfASvAlwmEy0NcTvmSge-Mvg-NIadoqJOReakU5LtEUBzL5T4vlbmHgZb3S9gEVJ2O6ImJLYwoCwhJ8SqgKJi141ht-S6NQFa0TPPHwbFA3pvs3xwvDaEQV~6RhQkY4I0dfc0dog4bWSgZVxrwG84-XoNxdVJVx3PmrwiBB2ZrUn2vec~G7BPfuHUcfLk3VLRQ0X~bOZMH1gdIX2Tsd-mriweMkQ__" style={{ width: '48px', height: '48px' }} className="rounded-circle mr-3" alt="Alice Johnson" />
              <div>
                <h5 className="card-title mb-1">Alice Johnson</h5>
                <p className="card-subtitle text-muted mb-0">March 27, 2024</p>
                <p>  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-star" viewBox="0 0 16 16">
  <path d="M2.866 14.85c-.078.444.36.791.746.593l4.39-2.256 4.389 2.256c.386.198.824-.149.746-.592l-.83-4.73 3.522-3.356c.33-.314.16-.888-.282-.95l-4.898-.696L8.465.792a.513.513 0 0 0-.927 0L5.354 5.12l-4.898.696c-.441.062-.612.636-.283.95l3.523 3.356-.83 4.73zm4.905-2.767-3.686 1.894.694-3.957a.56.56 0 0 0-.163-.505L1.71 6.745l4.052-.576a.53.53 0 0 0 .393-.288L8 2.223l1.847 3.658a.53.53 0 0 0 .393.288l4.052.575-2.906 2.77a.56.56 0 0 0-.163.506l.694 3.957-3.686-1.894a.5.5 0 0 0-.461 0z"/>
</svg><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-star" viewBox="0 0 16 16">
  <path d="M2.866 14.85c-.078.444.36.791.746.593l4.39-2.256 4.389 2.256c.386.198.824-.149.746-.592l-.83-4.73 3.522-3.356c.33-.314.16-.888-.282-.95l-4.898-.696L8.465.792a.513.513 0 0 0-.927 0L5.354 5.12l-4.898.696c-.441.062-.612.636-.283.95l3.523 3.356-.83 4.73zm4.905-2.767-3.686 1.894.694-3.957a.56.56 0 0 0-.163-.505L1.71 6.745l4.052-.576a.53.53 0 0 0 .393-.288L8 2.223l1.847 3.658a.53.53 0 0 0 .393.288l4.052.575-2.906 2.77a.56.56 0 0 0-.163.506l.694 3.957-3.686-1.894a.5.5 0 0 0-.461 0z"/>
